...
parser.add_argument('--modality', default='MIX2', help='the type of the input, AUDIO,RGB,FLOW, MIX1, MIX2, '
                                                          'or MIX3, MIX_ALL')
parser.add_argument('--lr', type=float, default=0.000515, help='learning rate (default: 0.0005)')
parser.add_argument('--batch-size', type=int, default=64, help='number of instances in a batch of data')
...
parser.add_argument('--seed', type=int, default=10, help='Random Initiation (default: 9)')
